...
<body>
    ...
    <div class="bgimg">
        ...
        if ($role === 'Teacher') {
            ...
            $generateLink = 'user.php';
        }
        ?>


        <div class="steps">
            <div><a href="<?php echo $generateLink; ?>" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'generate') ? 'active' : ''; ?>"><button>Mices Election 2024</button></a></div>
        </div>
    </div>
</body>
