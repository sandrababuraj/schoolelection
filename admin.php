...
<body>
    ...
    <div class="bgimg">
        ...
        // $generateLink = 'classtruncate.php';
        ...
        <div class="steps">
            <div><a href="register_position.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addsubjects') ? 'active' : ''; ?>"><button>Add Positions</button></a></div>
            <div><a href="register_candidate.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Add Candidates</button></a></div>
            <div><a href="stats.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Statistics</button></a></div>
            <div><a href="results.php" class="tablinks <?php echo (isset($_GET['tab']) && $_GET['tab'] == 'addlabs') ? 'active' : ''; ?>"><button>Result</button></a></div>
        </div>
    </div>
</body>
